      ...
      >
        {items.map((testimonial, idx) => {
          ...
          return (
            <li
              className={clsx(
                "relative flex w-[350px] max-w-full shrink-0 flex-col justify-between rounded-2xl border border-slate-700 px-8 py-6 md:w-[300px]"
              )}
              style={{
            ...
            >
              ...
              <div className="mt-4 inline-flex items-center">
                {testimonial.avatar ? (
                  <img alt="testimonial" src={testimonial.avatar} className="h-6 w-6 shrink-0 rounded-full object-cover object-center" />
                ) : (
