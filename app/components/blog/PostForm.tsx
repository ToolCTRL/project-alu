...
import { Form, useActionData, useNavigate, useNavigation, useParams, useSubmit } from "react-router";
...
export default function PostForm({ item, categories, tags, canUpdate = true, canDelete = true }: Readonly<Props>) {
  ...
  return (
    <Form method="post" className="space-y-6 pb-20">
      <input type="hidden" name="action" value={item ? "edit" : "create"} hidden readOnly />
            ...
            <div className="grid grid-cols-12 gap-3">
              ...
              {image && (
                <div className="col-span-12">
                  <img className="xl:border-border overflow-hidden rounded-lg shadow-xl xl:border-b" src={image} alt={t("models.post.image")} />
