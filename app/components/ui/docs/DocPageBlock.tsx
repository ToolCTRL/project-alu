          ...
          <div className={clsx("gap gap-2", viewMode === "rows" ? "grid grid-cols-1" : "grid grid-cols-2")}>
            ...
            <div className="space-y-2">
              <button type="button" onClick={toggleViewMode}>
                <h4 className="text-lg font-medium ">Editor</h4>
              </button>
              <div className="border-border border-2 border-dashed p-3">
                {item && <PageBlockForm type={type} item={item} onUpdate={onUpdate} onUpdateLayout={() => {}} />}
              </div>
            </div>

            {/* <div className="space-y-2">
              <h4 className="text-lg font-medium ">JSON</h4>
              <div className="overflow-hidden border-2 border-dashed border-border">
