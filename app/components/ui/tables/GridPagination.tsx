...
export default function GridPagination({ page, pageSize, totalItems, totalPages, defaultPageSize = Constants.DEFAULT_PAGE_SIZE }: Readonly<Props>) {
  ...
  useEffect(() => {
    const pageSizeParam = searchParams.get("pageSize")?.toString() ?? defaultPageSize.toString();
  ...
  return (
    <div className="text-muted-foreground flex items-center justify-end text-xs uppercase tracking-wide sm:justify-between" aria-label="Pagination">
      ...
      <div className="inline-flex items-center justify-center gap-2">
        <button
          ...
          className={clsx(
            "border-border bg-background inline-flex h-8 w-8 items-center justify-center rounded border focus:outline-hidden focus:ring-2 focus:ring-gray-500",
