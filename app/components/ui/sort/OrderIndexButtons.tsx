  ...
  return (
    <div className={clsx("flex items-center space-x-1 truncate", className)}>
      <button
        ...
        className={clsx(
          !editable || idx <= 0 ? " bg-secondary/90 cursor-not-allowed text-gray-300" : "hover:text-foreground hover:bg-secondary/90",
      ...
      <button
        ...
        className={clsx(
          !editable || idx >= items.length - 1 ? " bg-secondary/90 cursor-not-allowed text-gray-300" : "hover:text-foreground hover:bg-secondary/90",
          "text-muted-foreground bg-secondary h-4 w-4 px-0.5 py-0.5 focus:outline-hidden"
        )}
