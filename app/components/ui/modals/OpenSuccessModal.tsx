...
export default function OpenSuccessModal({ title, description, closeText, open, onClose, className }: Readonly<Props>) {
          ...
          >
            <DialogPanel className="bg-background inline-block w-full transform overflow-hidden rounded-lg px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:max-w-sm sm:p-6 sm:align-middle">
              ...
              <div className="mt-5 sm:mt-6">
                <button
                  type="button"
                  className="bg-foreground/90 text-background hover:bg-foreground mt-0 inline-flex w-full justify-center rounded-md border border-transparent px-4 py-2 text-sm font-medium shadow-2xs focus:outline-hidden focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                  onClick={onClose}
                >
