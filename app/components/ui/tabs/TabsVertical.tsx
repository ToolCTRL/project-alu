    ...
    <nav className={clsx("w-full space-y-1", className)} aria-label="Sidebar">
      ...
      >
        ...
        <select
          id="tabs"
          name="tabs"
          className="focus:border-theme-500 focus:ring-ring border-border block w-full rounded-md"
            ...
            {item.routePath ? (
              <Link
                ...
                className={clsx(
                  "border",
                  isCurrent(idx)
                    ? "border-border text-foreground bg-secondary/90 font-bold shadow-2xs"
                    : "hover:bg-secondary hover:text-foreground text-muted-foreground border-transparent",
