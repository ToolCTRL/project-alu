...
export default function DarkModeToggle({ className, disabled }: Readonly<Props>) {
...
export function DarkModeSvgs({ className, withLabel, filled }: { readonly className?: string; readonly withLabel?: boolean; readonly filled?: boolean }) {
  const { userSession } = useRootData();
  const isDarkMode = userSession?.lightOrDarkMode === "dark";
