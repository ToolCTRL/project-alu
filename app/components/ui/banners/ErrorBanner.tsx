...
export default function ErrorBanner({ title = "Error", text = "", redirect, children }: Readonly<Props>) {
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm leading-5 text-red-700 dark:text-red-300">
              <div>
                {text}{" "}
                {redirect && (
                  <Link className="mt-2 text-red-800 underline dark:text-red-50" to={redirect}>
