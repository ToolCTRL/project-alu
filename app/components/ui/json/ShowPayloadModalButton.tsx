    ...
    <>
      ...
      <Modal size={size} open={open} setOpen={setOpen}>
        <div className="flex justify-between space-x-2">
          <div className="text-foreground text-lg font-medium">{title ?? "Details"}</div>
          <div>
            {withCopy && (
              <button
                type="button"
        ...
        <div className="prose bg-foreground/90 border-border mt-2 max-h-96 overflow-auto rounded-lg border-2 border-dashed">
