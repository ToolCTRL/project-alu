        ...
        {asToggle ? (
          <Switch
            ...
            className={clsx(
              ...
              "focus:ring-primary relative inline-flex h-5 w-8 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-hidden focus:ring-2 focus:ring-offset-2",
              icon && "pl-10",
          ...
          >
            <span
              ...
              className={clsx(
                ...
                "bg-background pointer-events-none inline-block h-4 w-4 transform rounded-full shadow-xs ring-0 transition duration-200 ease-in-out"
              )}
            />
          </Switch>
        ) : (
          <Checkbox
            ...
            className={clsx(
              ...
              " text-primary focus:ring-primary border-border mt-1 h-6 w-6 cursor-pointer rounded",
              className,
              icon && "pl-10"
            )}
          />
