...
export default function InputCheckboxWithDescription(props: Props) {
  const { name, title, value, setValue, description, className, help, disabled = false, autoFocus } = props;
