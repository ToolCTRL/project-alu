          ...
          return (
            <Button asChild>
              <LinkOrAhref
                ...
                // className={clsx(
                //   className,
                //   "borde1-transparent focus:ring-accent-300 inline-flex items-center space-x-2 rounded-md border px-4 py-2 text-sm font-medium text-white shadow-2xs focus:outline-hidden focus:ring-2",
                //   disabled && "cursor-not-allowed opacity-75",
                //   !destructive && "bg-primary",
                //   destructive && "bg-red-600",
                //   !disabled && !destructive && !className && "hover:bg-accent-900 hover:text-accent-100 focus:ring-ring",
                //   !disabled && destructive && "hover:bg-red-700 focus:ring-red-500"
                // )}
                autoFocus={autoFocus}
                onClick={onClicked}
