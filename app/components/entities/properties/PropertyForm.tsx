              ...
              <div className="w-full">
                ...
                <div className="mt-1 flex rounded-md shadow-2xs">
                  ...
                  <button
                    ...
                    className="focus:border-border focus:ring-ring border-border bg-secondary hover:bg-secondary/90 text-foreground/80 relative -ml-px inline-flex items-center space-x-2 rounded-r-md border px-4 py-1.5 text-sm font-medium focus:outline-hidden focus:ring-1"
                  >
