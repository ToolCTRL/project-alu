            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="w-full">
                <div className="flex items-center justify-between space-x-2">
                  <label htmlFor="select" className="text-foreground/80 block text-sm font-medium">
                    Options
                  </label>
                ...
                <div className="border-border bg-secondary mt-1 space-y-2 rounded-md border-2 border-dashed p-2">
