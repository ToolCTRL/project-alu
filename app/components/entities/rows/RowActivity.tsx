...
import { Form, useLocation, useSubmit, useNavigation } from "react-router";
    ...
    <section className="relative">
      <div className="space-y-3">
        <div className="divide-border divide-y ">
          {withTitle && (
            <div className="pb-2">
              <h2 id="activity-title" className="text-foreground text-sm font-medium">
                    ...
                    <Form ref={formRef} onSubmit={handleSubmit} method="post" className="space-y-2">
                      <div>
                        ...
                        <textarea
                          ...
                          rows={3}
                          className={clsx(
                            "border-border block w-full rounded-md border shadow-2xs focus:border-gray-900 focus:ring-gray-900 sm:text-sm",
                            (isAdding || !appOrAdminData.user) && "bg-secondary/90 cursor-not-allowed"
                          )}
                      ...
                      <div className="flex items-center justify-end space-x-4">
                        <Button variant="outline" disabled={isAdding || !appOrAdminData.user} type="submit">
                          {t("shared.comment")}
                        </Button>
                      </div>
                    </Form>
