  ...
  return (
    <div>
      <div className="space-y-3">
        ...
        <div className="bg-background border-border rounded-md border px-4 py-5 shadow-xs">
                  ...
                  <li key={activity.id}>
                    <div className="relative pb-8">
                      ...
                      <div className="relative flex space-x-3">
                        <div>
                          <span className={clsx("bg-secondary/90 flex h-8 w-8 items-center justify-center rounded-full ring-8 ring-white")}>
                            <svg
                        ...
                        <div className="grow">
                          <div className="flex min-w-0 flex-1 justify-between space-x-4">
                            ...
                            <div className="text-muted-foreground truncate whitespace-nowrap text-right text-xs lowercase">
                              {activity.createdAt && (
