      ...
      <div className="">
        <div className="flex min-h-full flex-col pb-12 pt-16">
          <main className="mx-auto flex w-full max-w-7xl grow flex-col justify-center px-4 sm:px-6 lg:px-8">
            {withLogo && <div className="flex shrink-0 justify-center">{logo ? <img className="h-9 w-auto" src={logo} alt="Logo" /> : <Logo />}</div>}
            <div className="py-16">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mt-2 text-base">Sorry, we couldn’t find the page you’re looking for.</p>
