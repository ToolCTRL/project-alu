  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <button
        ...
        className={clsx(
          "border-border text-muted-foreground focus:text-foreground mt-2 flex items-center space-x-1 rounded-md border px-2 py-1 text-xs focus:ring-3 focus:ring-gray-300 focus:ring-offset-1",
