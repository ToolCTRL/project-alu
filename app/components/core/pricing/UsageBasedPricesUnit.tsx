...
export default function UsageBasedPricesUnit({ item, onUpdate, disabled }: Readonly<Props>) {
  ...
  return (
    <div className="border-border mt-2 border-t p-2">
      <div className="space-y-/2">
        ...
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
          ...
          <InputText
            ...
            setValue={(e) => setUnitTitle(e?.toString() ?? "")}
            value={unitTitle}
            required
            placeholder="i.e. API Call"
          />
          <InputText
            className="col-span-2 sm:col-span-2"
            disabled={disabled}
            name="unitTitlePlural"
            title={t("shared.titlePlural")}
            setValue={(e) => setUnitTitlePlural(e?.toString() ?? "")}
            value={unitTitlePlural}
            required
            placeholder="i.e. API Calls"
          />
          <InputSelect
            disabled={disabled}
            name="usageType"
