      ...
      {index !== undefined && (
        <div className="flex items-center space-x-1 truncate">
          ...
          <button
            ...
            className={clsx(
              index <= 0 || !editable ? " bg-secondary/90 cursor-not-allowed text-gray-300" : "hover:text-foreground hover:bg-secondary/90",
          ...
          <button
            ...
            className={clsx(
              isLastItem() || !editable ? " bg-secondary/90 cursor-not-allowed text-gray-300" : "hover:text-foreground hover:bg-secondary/90",
              "text-muted-foreground bg-secondary h-4 w-4 px-0.5 py-0.5 focus:outline-hidden"
            )}
