  ...
  return (
    <div className="flex items-center">
      {feature.type > 0 && feature.type !== SubscriptionFeatureLimitType.NOT_INCLUDED ? (
        <svg className=" text-primary h-4 w-4 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          <path
            fillRule="evenodd"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className=" h-4 w-4 shrink-0 text-gray-300" viewBox="0 0 20 20" stroke="#FFFFF" fill="currentColor">
          <path
            fillRule="evenodd"
