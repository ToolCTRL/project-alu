...
export default function ToggleBillingPeriod({
    ...
    return (
      <div className={clsx("flex items-center justify-center space-x-4", className)}>
        ...
        <button
          ...
          type="button"
          className={clsx(
            "focus:ring-primary relative rounded-full focus:outline-hidden focus:ring-2 focus:ring-offset-2",
        ...
        >
          <div className={clsx("bg-primary rounded-full shadow-md outline-hidden transition", size === "sm" && "h-4 w-8", size === "md" && "h-8 w-16")}></div>
          <div
            className={clsx(
              "bg-primary-foreground absolute left-1 top-1 inline-flex transform items-center justify-center rounded-full shadow-2xs transition-all duration-200 ease-in-out",
              size === "sm" && "h-2 w-2",
              size === "md" && "h-6 w-6",
  ...
  if (possibleBillingPeriods.length > 1) {
    return (
      <div className={className}>
        <select
          ...
          className={clsx(
            "focus:ring-primary focus:border-primary border-border text-foreground block w-full rounded-md py-2 pl-3 pr-10 text-base focus:outline-hidden sm:text-sm",
