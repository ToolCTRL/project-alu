                    ...
                    {headers.map((header, idx) => {
                      return (
                        <th
                          ...
                          scope="col"
                          className={clsx(
                            "text-muted-foreground select-none truncate px-2 py-1 text-left text-xs font-medium tracking-wider",
                            header.name && "hover:text-foreground/80 cursor-pointer"
                          )}
                        >
                  ...
                  {items.map((item, idx) => {
                    return (
                      <tr key={idx}>
                        ...
                        <td className="text-muted-foreground whitespace-nowrap px-2 py-1 text-sm">
                          <UserBadge
                            item={{
                              id: "",
                              email: item.email,
                        ...
                        <td className="text-muted-foreground w-20 whitespace-nowrap px-2 py-2 text-sm">
