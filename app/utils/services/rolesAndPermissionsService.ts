...
export const defaultAppRoles: CreateRoleDto[] = [
  ...
  { name: DefaultAppRoles.TenantAdmin, description: "Tenant admin with elevated permissions", type: "app", assignToNewUsers: false },
  { name: DefaultAppRoles.TenantManager, description: "Tenant manager for teams and automation", type: "app", assignToNewUsers: false },
  { name: DefaultAppRoles.TenantAgent, description: "Tenant agent with scoped permissions", type: "app", assignToNewUsers: true },
...
export const defaultPermissions: CreatePermissionDto[] = [
  ...
  {
    inRoles: [DefaultAdminRoles.SuperAdmin, DefaultAdminRoles.ProductDesigner, DefaultAdminRoles.Developer],
    name: "admin.workflows.view",
    description: "View workflows page",
    type: "admin",
  },
  {
    inRoles: [DefaultAdminRoles.SuperAdmin, DefaultAdminRoles.ProductDesigner, DefaultAdminRoles.Developer],
  ...
  { inRoles: [DefaultAdminRoles.SuperAdmin], name: "admin.surveys", description: "Manage surveys", type: "admin" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager, DefaultAppRoles.TenantAgent], name: "tenant.dashboard.view", description: "View tenant admin dashboard", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager, DefaultAppRoles.TenantAgent], name: "tenant.team.view", description: "View team and roles", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager], name: "tenant.team.manage", description: "Manage team and roles", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager], name: "tenant.billing.view", description: "View billing", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin], name: "tenant.billing.update", description: "Update billing", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager], name: "tenant.automations.view", description: "View automations", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager], name: "tenant.automations.update", description: "Update automations", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager, DefaultAppRoles.TenantAgent], name: "tenant.entities.view", description: "View tenant entities", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager], name: "tenant.entities.create", description: "Create tenant entities", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager], name: "tenant.entities.update", description: "Update tenant entities", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin], name: "tenant.entities.delete", description: "Delete tenant entities", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager], name: "tenant.workflows.view", description: "View tenant workflows", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager], name: "tenant.workflows.update", description: "Update tenant workflows", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager], name: "tenant.pages.view", description: "View tenant pages", type: "tenant" },
  { inRoles: [DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager, DefaultAppRoles.TenantAgent], name: "tenant.support.view", description: "Access support links", type: "tenant" },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.User, DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager, DefaultAppRoles.TenantAgent],
    name: "app.dashboard.view",
    description: "View dashboard page",
    type: "app",
  },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager],
  ...
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin],
  ...
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager],
    name: "app.settings.roles.view",
    description: "View user roles",
    type: "app",
  },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin],
    name: "app.settings.roles.set",
    description: "Set user roles",
    type: "app",
  },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin],
    name: "app.settings.groups.full",
    description: "Manage all user groups",
    type: "app",
  },
  {
    inRoles: [
      DefaultAppRoles.SuperUser,
      DefaultAppRoles.Admin,
      DefaultAppRoles.BillingAdmin,
      DefaultAppRoles.TenantAdmin,
      DefaultAppRoles.TenantManager,
    ],
  ...
  { inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.TenantAdmin], name: "app.settings.account.delete", description: "Delete account", type: "app" },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager],
    name: "app.settings.accounts.view",
    description: "View accounts page",
    type: "app",
  },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin],
    name: "app.settings.accounts.create",
    description: "Create account",
    type: "app",
  },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin],
    name: "app.settings.accounts.update",
    description: "Update account",
    type: "app",
  },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin],
    name: "app.settings.accounts.delete",
    description: "Delete account",
    type: "app",
  },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager],
    name: "app.settings.apiKeys.view",
    description: "View API Keys page",
    type: "app",
  },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager],
    name: "app.settings.apiKeys.create",
    description: "Create API Key",
    type: "app",
  },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager],
    name: "app.settings.apiKeys.update",
    description: "Update API Key",
    type: "app",
  },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin],
    name: "app.settings.apiKeys.delete",
    description: "Delete API Key",
    type: "app",
  },
  {
    inRoles: [DefaultAppRoles.SuperUser, DefaultAppRoles.Admin, DefaultAppRoles.TenantAdmin, DefaultAppRoles.TenantManager],
    name: "app.settings.auditTrails.view",
    description: "View Audit Trails page",
    type: "app",
  },
];
...
export async function seedRolesAndPermissions(adminEmail?: string): Promise<void> {
  ...
  console.log("🌱 Seeding admin roles and permissions", adminRoles.length);
