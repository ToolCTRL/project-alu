...
function ContactForm() {
  ...
  return (
    <div className="mt-9 grid grid-cols-1 gap-x-1 gap-y-4 sm:grid-cols-2 sm:gap-x-4">
      <div>
        {/* <label htmlFor="first_name" className="block text-sm font-medium text-foreground dark:text-slate-500">
      ...
      <div>
        {/* <label htmlFor="last_name" className="block text-sm font-medium text-foreground dark:text-slate-500">
      ...
      <div className="sm:col-span-2">
        {/* <label htmlFor="email" className="block text-sm font-medium text-foreground dark:text-slate-500">
      ...
      <div>
        {/* <div className="flex justify-between">
          <label htmlFor="company" className="block text-sm font-medium text-foreground dark:text-slate-500">
      ...
      <div className="sm:col-span-2">
        {/* <div className="flex justify-between">
          <label htmlFor="comments" className="block text-sm font-medium text-foreground dark:text-slate-500">
      ...
      <div className="text-right sm:col-span-2">
        <ButtonPrimary type="submit">{t("front.contact.send")}</ButtonPrimary>
      </div>
    </div>
  );
}
