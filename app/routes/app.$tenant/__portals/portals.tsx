    ...
    >
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-3 gap-4">
          {data.items.map((item) => {
            return (
              <div key={item.id} className="border-border hover:border-primary bg-background group relative flex flex-col rounded-lg border hover:shadow-2xs">
                    ...
                    <div className="flex items-center space-x-2">
                      {item.brandingIcon && (
                        <img
                          ...
                          alt={item.title}
                          className="bg-secondary/90 inline-block h-9 w-9 shrink-0 rounded-full object-contain p-0.5 shadow-2xs"
                        />
                      )}
