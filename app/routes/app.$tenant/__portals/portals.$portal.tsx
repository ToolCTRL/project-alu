    ...
    <SidebarIconsLayout
      ...
      items={[
        ...
        },
        {
          ...
          icon: <IconPages className=" text-muted-foreground h-5 w-5 shrink-0" aria-hidden="true" />,
          iconSelected: <IconPages className=" text-muted-foreground h-5 w-5 shrink-0" aria-hidden="true" />,
        },
        {
        ...
        },
        {
          ...
          icon: <CurrencyIcon className=" text-muted-foreground h-5 w-5 shrink-0" aria-hidden="true" />,
          iconSelected: <CurrencyIcon className=" text-muted-foreground h-5 w-5 shrink-0" aria-hidden="true" />,
        ...
        },
        {
          ...
          icon: <ExclamationTriangleIcon className=" text-muted-foreground h-5 w-5 shrink-0" aria-hidden="true" />,
          iconSelected: <ExclamationTriangleIcon className=" text-muted-foreground h-5 w-5 shrink-0" aria-hidden="true" />,
          bottom: true,
        },
      ]}
    >
