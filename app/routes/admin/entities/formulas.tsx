...
import { getAllFormulas, getFormula } from "~/modules/formulas/db/formulas.db.server";
      ...
      <TableSimple
        ...
        headers={[
          ...
          },
          {
            ...
            title: "Calculations",
            value: (i) => (
              <Link to={`/admin/entities/formulas/logs?formulaId=${i.id}`} className="text-muted-foreground text-sm hover:text-blue-700 hover:underline">
