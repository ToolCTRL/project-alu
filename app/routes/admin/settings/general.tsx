...
export default function AdminSettingsGeneral() {
  ...
  return (
    <EditPageLayout title={<BackButtonWithTitle href="/admin/settings">{t("settings.admin.general.title")}</BackButtonWithTitle>}>
      <Form method="post" className="mt-6 space-y-8">
                  ...
                  options={defaultThemes.map((item) => ({
                    ...
                    component: (
                      <div className="flex items-center space-x-2">
                        <div
                          className={clsx(`theme-${item.value}`, "bg-primary text-primary inline-flex shrink-0 items-center rounded-full text-xs font-medium")}
                        >
        ...
        <InputGroup title="Branding">
          <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
            ...
            <div className="sm:col-span-3">
              <InputImage name="logoDarkMode" title="Logo (Dark Mode)" value={logoDarkMode} setValue={setLogoDarkMode} disabled={!canUpdate} className="dark" />
            </div>
            ...
            <div className="sm:col-span-3">
              <InputImage name="iconDarkMode" title="Icon (Dark Mode)" value={iconDarkMode} setValue={setIconDarkMode} disabled={!canUpdate} className="dark" />
            </div>
            {/* <div className="sm:col-span-6">
                <PreviewIcon />
              </div> */}
