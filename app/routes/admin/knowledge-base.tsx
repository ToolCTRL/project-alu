...
export const loader = async ({ request, params }: LoaderFunctionArgs) => {
  ...
  await verifyUserHasPermission(request, "admin.kb.view", tenantId);
  if (tenantId) {
    throw Response.json({ error: "Knowledge Base management is operator-only" }, { status: 403 });
  }
  ...
  return (
    <SidebarIconsLayout
      ...
      items={[
        ...
        {
          name: t("knowledgeBase.article.plural"),
