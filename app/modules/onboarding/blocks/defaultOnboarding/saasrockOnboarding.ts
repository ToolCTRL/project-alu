...
export const saasrockOnboardingStepBlocks: OnboardingStepBlockDto[] = [
  ...
  },
  {
    ...
    gallery: [],
    input: [
      { type: "text", name: "firstName", title: "First name", isRequired: true, options: [] },
      { type: "text", name: "lastName", title: "Last name", isRequired: false, options: [] },
      {
        type: "select",
  ...
  },
  {
    ...
    description: "",
    links: [],
    gallery: [{ type: "image", title: "", src: "https://www.gifcen.com/wp-content/uploads/2021/05/the-end-gif-13.gif" }],
    input: [],
