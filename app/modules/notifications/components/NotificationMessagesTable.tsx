    ...
    <TableSimple
      ...
      headers={[
        ...
        { name: "channel", title: "Channel", value: (i) => i.channel },
        {
          name: "seen",
          title: "Seen",
          value: (i) => <div>{i.seen ? <CheckIcon className="text-theme-500 h-4 w-4" /> : <XIcon className="text-muted-foreground h-4 w-4" />}</div>,
        },
        {
          name: "read",
          title: "Read",
          value: (i) => <div>{i.read ? <CheckIcon className="text-theme-500 h-4 w-4" /> : <XIcon className="text-muted-foreground h-4 w-4" />}</div>,
        },
        {
          name: "payload",
          title: "Payload",
