      ...
      <div className="dark:text-foreground dark:bg-secondary bg-gray-900 p-2 text-gray-50">
        <div className="flex justify-center space-x-2">
          <ChatGptSetParametersButton
            page={page}
            className={clsx(
              "flex items-center justify-center space-x-1 rounded-md border border-transparent px-4 py-2 text-xs font-medium shadow-2xs sm:text-sm",
              "bg-foreground/90 border-gray-700 text-gray-100 hover:bg-gray-700"
            )}
            onGenerate={(info) => {
