        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-prose text-lg">
                  ...
                  <div className="mx-auto max-w-7xl px-3 py-3 sm:pl-6 lg:pl-8">
                    <div className="flex flex-wrap items-center justify-between">
                      ...
                      <div className="order-2 shrink-0 sm:order-3 sm:ml-3">
                        <button
                          type="button"
                          className="hover:bg-accent-500 -mr-1 flex rounded-md p-2 focus:outline-hidden focus:ring-2 focus:ring-white sm:-mr-2"
                        >
            ...
            <div className="space-y-2">
              <div className="text-muted-foreground flex items-center justify-between space-x-2 px-2 text-center text-base tracking-wide">
          ...
          <div className="prose prose-lg prose-indigo dark:prose-dark mx-auto mt-6 max-w-2xl space-y-6">
            {item.data.post.image && (
              <img className="border-border rounded-lg border shadow-lg dark:border-gray-800" src={item.data.post.image} alt={item.data.post.title} />
            )}
