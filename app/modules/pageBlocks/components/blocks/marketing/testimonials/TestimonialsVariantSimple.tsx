              ...
              >
                <div className="group: bg-secondary h-full rounded-lg p-6">
                  <svg
                    ...
                    fill="currentColor"
                    className="text-muted-foreground mb-2 block h-3 w-3"
                  ...
                  {testimonial.title && (
                    <div className="text-foreground mb-2 flex justify-between space-x-2 text-lg font-medium dark:text-white">
                      <div>
                  ...
                  <div className="inline-flex items-center">
                    {testimonial.avatar ? (
                      <img alt="testimonial" src={testimonial.avatar} className="h-12 w-12 shrink-0 rounded-full object-cover object-center" />
                    ) : (
