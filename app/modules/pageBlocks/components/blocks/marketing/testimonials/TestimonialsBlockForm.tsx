...
import {
  TestimonialsBlockDto,
  TestimonialsBlockStyle,
  TestimonialsBlockStyles,
} from "~/modules/pageBlocks/components/blocks/marketing/testimonials/TestimonialsBlockUtils";
    ...
    <div className="space-y-4">
      <InputGroup title="Design">
        <InputRadioGroup
          ...
          options={TestimonialsBlockStyles.map((f) => f)}
        />
      </InputGroup>
