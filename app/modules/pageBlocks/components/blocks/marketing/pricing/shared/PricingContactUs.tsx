    ...
    <div className="relative lg:mx-4">
      <div>
        <div className="border-border mx-auto overflow-hidden rounded-lg border shadow-xl lg:flex">
          <div className="bg-primary text-primary-foreground flex-1 px-6 py-8 lg:p-12">
            ...
            <div className="mt-8">
              <div className="flex items-center">
                <h4 className="shrink-0 pr-4 text-sm font-semibold uppercase tracking-wider">{t("pricing.whatsIncluded")}</h4>
          ...
          <div className="px-6 py-8 text-center lg:flex lg:shrink-0 lg:flex-col lg:justify-center lg:p-12">
            ...
            <div className="mt-6">
              <div className="mx-auto max-w-md rounded-md shadow-xs">
                <ButtonEvent
                  event={{ action: "click", category: "pricing", label: "contact", value: "contact" }}
                  to="/contact"
                  className="bg-primary hover:bg-primary/95 text-primary-foreground inline-flex w-full justify-center rounded-md border-0 px-4 py-3 text-lg shadow-2xs focus:outline-hidden"
                >
                  {t("pricing.contact")}
                </ButtonEvent>
              </div>
