          ...
          >
            ...
            <div className="flex justify-end">
              <ButtonPrimary
                ...
                sendEvent={!!email}
                // className="bg-theme-500 hover:bg-theme-600 inline-flex justify-center rounded-md border-0 px-4 py-2 text-base text-white shadow-2xs focus:outline-hidden"
              >
