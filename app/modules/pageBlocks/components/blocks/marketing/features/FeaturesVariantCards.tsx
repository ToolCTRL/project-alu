          ...
          {!featuresOnly && (
            <div>
              <div className="flex justify-center space-x-2">
                <Link
                  to="https://core.saasrock.com/?ref=saasrock.com&utm_medium=features&utm_campaign=v0-9-3"
                  target="_blank"
                  className="inline-flex items-center rounded-md border border-transparent bg-gray-800 px-4 py-2 text-sm font-medium text-white shadow-2xs hover:bg-gray-900 focus:outline-hidden focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:hover:bg-gray-700"
                >
                  Core 🪨 Edition Demo
                </Link>

                <Link
                  to="https://enterprise.saasrock.com/?ref=saasrock.com&utm_medium=features&utm_campaign=v0-9-3"
                  target="_blank"
                  className="inline-flex items-center rounded-md border border-transparent bg-gray-800 px-4 py-2 text-sm font-medium text-white shadow-2xs hover:bg-gray-900 focus:outline-hidden focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:hover:bg-gray-700"
                >
                  Pro 🚀 Edition Demo
