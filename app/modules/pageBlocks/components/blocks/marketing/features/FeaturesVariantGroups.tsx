                  ...
                  <div className="flex flex-col space-y-3">
                    ...
                    <div className="flex flex-col space-y-4">
                      {currentFeature.highlight && (
                        <div>
                          <div className="bg-primary text-primary-foreground ring-ring inline-flex cursor-default items-center rounded-md px-2 py-1 text-sm font-bold ring-3">
                    ...
                    {currentFeature.link ? (
                      ...
                      >
                        <img
                          ...
                          className=" h-52 overflow-hidden rounded-md border-gray-900 object-cover shadow-2xs transition-all duration-500  hover:border-gray-800 sm:h-72 md:h-full"
                        />
                      </ButtonEvent>
                    ) : (
                      <img
                        ...
                        src={currentFeature.img}
                        alt={currentFeature.name}
                        className=" h-52 overflow-hidden rounded-md border-gray-900 object-cover shadow-2xs transition-all duration-500  sm:h-72 md:h-full"
                      />
                    )}
                  </div>
                </div>
