...
export const FeaturesBlockStyles = [
  ...
  { value: "alternating", name: "Alternating" },
] as const;
export type FeaturesBlockStyle = (typeof FeaturesBlockStyles)[number]["value"];

export const defaultFeaturesBlock: FeaturesBlockDto = {
  style: "list",
