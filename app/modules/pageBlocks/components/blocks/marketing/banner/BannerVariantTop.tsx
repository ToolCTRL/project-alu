        ...
        <div className="border-border bg-primary text-primary-foreground border-b-2">
          <div className="mx-auto max-w-7xl px-3 py-1.5 sm:px-6 sm:py-3 lg:px-8">
            <div className="flex w-full items-center space-x-3 lg:w-auto lg:justify-end">
              ...
              <div className="order-3 ml-2 hidden shrink-0 sm:flex">
                <button
                  type="button"
                  onClick={() => {
                    setOpen(false);
                  ...
                  className="text-primary-foreground hover:border-border -mr-1 flex rounded-md border border-transparent p-2 focus:outline-hidden focus:ring-2 sm:-mr-2"
                >
