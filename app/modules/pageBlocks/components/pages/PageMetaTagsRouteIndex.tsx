      ...
      <Form method="post" className="divide-y-gray-200 space-y-2 divide-y">
                  ...
                  return (
                    <div key={`tag-${tag.name}-${index}`} className="group relative grid grid-cols-4 gap-2">
                      <button
                        ...
                        type="button"
                        className="text-muted-foreground bg-background absolute right-0 top-0 hidden origin-top-right justify-center rounded-full hover:text-red-500 group-hover:flex"
                      >
                      ...
                      {["og:image", "twitter:image"].includes(metaTags[index].name) && (
                        <div className="bg-secondary col-span-4 overflow-hidden rounded-lg border-2 border-dashed border-gray-800 p-3">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between pt-4">
            <ButtonTertiary destructive onClick={onReset}>
              Reset
            </ButtonTertiary>
