  ...
  return (
    <div className="space-y-1">
      ...
      <div className="space-y-1">
        {items.map((item, idx) => {
          return (
            <div key={item.name} className="border-border bg-background rounded-md border px-4 py-1 shadow-2xs">
                ...
                <div className="flex items-center space-x-2 truncate">
                  <div className=" flex items-center space-x-3 truncate">
                    ...
                    <div className="flex items-center space-x-2">
                      <JsonPropertyTypeIcon type={item.type} className="text-muted-foreground h-4 w-4" />
                    </div>
        ...
        <div>
          <button
            type="button"
            onClick={() => setSelectedProperty(null)}
            className="focus:ring-ring border-border hover:border-border relative block w-full rounded-lg border-2 border-dashed px-12 py-3 text-center focus:outline-hidden focus:ring-2 focus:ring-offset-2"
          >
