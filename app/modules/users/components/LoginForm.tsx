          ...
          <Form method="post" className="w-full space-y-3">
            ...
            <div>
              ...
              <InputText
                ...
                type="email"
                required
                // className="focus:border-theme-500 focus:ring-ring relative mt-1 block w-full appearance-none rounded-md border border-border px-3 py-2 text-sm text-foreground placeholder-gray-500 focus:z-10 focus:outline-hidden sm:text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-slate-200"
            ...
            <div className="pt-2">
              <LoadingButton disabled={navigation.state !== "idle"} className="block w-full py-2" type="submit" actionName="login">
