            ...
            <div id="components" className="text-foreground flex flex-wrap">
              ...
              <div className="">
                <button
                  ...
                  className="relative m-1 block w-full rounded-lg border-2 border-dashed border-blue-300 bg-blue-50 p-1 text-center text-blue-600 hover:border-blue-400 hover:bg-blue-100 focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
