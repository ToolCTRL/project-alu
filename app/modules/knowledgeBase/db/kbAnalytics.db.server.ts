...
export async function createKnowledgeBaseView({ userAnalyticsId, knowledgeBaseId }: { userAnalyticsId: string | null; knowledgeBaseId: string }) {
  if (!userAnalyticsId) {
    return;
  }
...
export async function createKnowledgeBaseArticleView({ userAnalyticsId, articleId }: { userAnalyticsId: string | null; articleId: string }) {
  if (!userAnalyticsId) {
    return;
  }
...
export async function voteArticle({ userAnalyticsId, articleId, type }: { userAnalyticsId: string | null; articleId: string; type: "up" | "down" }) {
  if (!userAnalyticsId) {
    return;
  }
  if (type === "up") {
...
export async function getArticleStateByUserAnalyticsId({ userAnalyticsId, articleId }: { userAnalyticsId: string | null; articleId: string }) {
  if (!userAnalyticsId) {
    return {
      hasThumbsUp: false,
      hasThumbsDown: false,
