      ...
      <div className="">
        ...
        <div className="space-y-4 px-4 py-4">
          <div className="space-y-2">
            ...
            <div>
              <div className="text-muted-foreground bg-secondary/90 w-full rounded-lg px-1 py-1 text-sm focus:outline-hidden">
          ...
          {blockRun === null ? (
            <div>
              {execution ? (
                <div className="text-foreground/80 text-sm font-medium">Not executed</div>
              ) : (
                <div className="text-foreground/80 text-sm font-medium">Select a workflow execution to view the block run</div>
              )}
            </div>
          ) : (
            <Fragment>
              <div className="flex justify-between">
                <div>
                  <div className="text-foreground/80 text-sm font-medium">Status</div>
                  <div className="text-muted-foreground text-sm">{blockRun.status}</div>
                </div>
              </div>

              <div className="flex justify-between">
                <div>
                  <div className="text-foreground/80 text-sm font-medium">Started</div>
                  <div className="text-muted-foreground text-sm">{DateUtils.dateAgo(blockRun.startedAt)}</div>
                </div>
                <div>
                  <div className="text-foreground/80 text-sm font-medium">Ended</div>
                  <div className="text-muted-foreground text-sm">{DateUtils.dateAgo(blockRun.endedAt)}</div>
                </div>
              </div>
              ...
              {blockRun.output && (
                <Fragment>
                  <div className="border-border border-t"></div>
                  <div className="space-y-3">
                    <div className="text-foreground/80 text-sm font-medium">Workflow Block Output</div>
                    <div className="space-y-1">
                      <div className="overflow-hidden">
                        <Editor
