          ...
          <div className="space-y-4 px-4 py-4">
            <div className="space-y-2">
              <div className="space-y-1">
                <div className="border-border flex items-center justify-between space-x-2 border-b border-dashed pb-1">
    ...
    <div className="space-y-4 p-4">
      <div className="space-y-1">
        <div className="flex justify-between space-x-2">
          <div className="text-foreground font-medium">Execute Workflow</div>
        </div>
        <div className="flex flex-col space-y-2">
          <Link to={UrlUtils.getModulePath(params, `workflow-engine/workflows/${workflow.id}/run/manual`)}>
            <div className="border-border bg-secondary hover:bg-secondary/90 rounded-md border border-dashed p-3 hover:border-dotted hover:border-gray-800">
              <div className="space-y-1">
                <div className="text-foreground text-sm font-medium">Run manually</div>
                <div className=" text-muted-foreground text-xs">Set the input data to run the workflow manually.</div>
              </div>
            </div>
          </Link>
          <Link to={UrlUtils.getModulePath(params, `workflow-engine/workflows/${workflow.id}/run/api`)}>
            <div className="border-border bg-secondary hover:bg-secondary/90 rounded-md border border-dashed p-3 hover:border-dotted hover:border-gray-800">
              <div className="space-y-1">
                <div className="text-foreground text-sm font-medium">API call</div>
                <div className=" text-muted-foreground text-xs">Call the workflow using the API.</div>
              </div>
            </div>
          </Link>
        </div>
