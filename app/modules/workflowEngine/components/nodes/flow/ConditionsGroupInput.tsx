    ...
    <div>
      {conditions.length === 0 ? (
        <div className=" border-border bg-secondary/90 flex flex-col items-center justify-center rounded-md border p-2 text-center">
          <div className="text-muted-foreground text-sm font-medium">No conditions</div>
        </div>
      ) : (
          ...
          <div className="flex h-10 items-center justify-between space-x-2">
            ...
            {conditions.length > 1 && (
              <select
                ...
                className="border-border bg-secondary hover:bg-secondary/90 col-span-2 rounded-lg border px-2 py-2 pr-10 text-sm focus:outline-hidden"
              >
            ...
            {conditions.map((condition, idx) => (
              <div key={`condition-${condition.variable}-${idx}`} className="group relative">
                ...
                <div className="grid grid-cols-10 gap-1">
                  ...
                  {/* <input
                    className="col-span-4 bg-secondary border border-border hover:bg-secondary/90 rounded-lg w-full px-2 py-2 text-sm focus:outline-hidden"
                    type="text"
                    placeholder="Value"
        ...
        <div className="flex justify-between space-x-2 pt-2">
          <div>
            ...
            <ButtonSecondary
              ...
              // className="bg-secondary hover:bg-secondary/90 border border-border px-2 py-1 rounded-md text-muted-foreground text-xs"
            >
              + Condition
            </ButtonSecondary>
          </div>
