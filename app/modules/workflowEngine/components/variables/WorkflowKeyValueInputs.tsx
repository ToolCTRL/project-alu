...
export default function WorkflowKeyValueInputs({
  ...
  return (
    <div className="border-border bg-secondary space-y-1 rounded-md border p-2">
      ...
      <button onClick={handleAddPair} className="border-border text-muted-foreground bg-secondary hover:bg-secondary/90 rounded-md border px-2 py-1 text-xs">
        Add
      </button>
    </div>
  );
