...
export const CRM_PIPELINE_TEMPLATE: EntitiesTemplateDto = {
  entities: [
    {
      ...
      properties: [
        ...
        { name: "domain", title: "Domain", type: "string", subtype: "url" },
        { name: "industry", title: "Industry", type: "string" },
        { name: "size", title: "Size", type: "number" },
        { name: "phone", title: "Phone", type: "string" },
        { name: "email", title: "Email", type: "string", subtype: "email" },
    ...
    },
    {
      ...
      properties: [
        ...
        { name: "email", title: "Email", type: "string", subtype: "email", isDisplay: true },
        { name: "phone", title: "Phone", type: "string" },
        { name: "jobTitle", title: "Job Title", type: "string" },
        {
          ...
          type: "select",
          options: [
            { value: "decision-maker", name: "Decision Maker", color: Colors.GREEN },
            { value: "influencer", name: "Influencer", color: Colors.BLUE },
            { value: "user", name: "User", color: Colors.PURPLE },
          ],
        },
        { name: "isPrimary", title: "Primary Contact", type: "boolean" },
      ],
    },
    {
      type: DefaultEntityTypes.All,
      ...
      showInSidebar: true,
      properties: [
        { name: "title", title: "Title", type: "string", isRequired: true, isDisplay: true },
        { name: "amount", title: "Amount", type: "number", isDisplay: true },
        { name: "currency", title: "Currency", type: "string", attributes: [{ name: PropertyAttributeName.DefaultValue, value: "USD" }] },
        { name: "closeDate", title: "Close Date", type: "date" },
        {
          name: "stage",
          title: "Stage",
          type: "select",
          isDisplay: true,
          options: [
            { value: "anfrage-erhalten", name: "Anfrage erhalten", color: Colors.GRAY },
            { value: "vq-step1", name: "Vorqualifizierung Step 1 (Vertriebs-ID/Anruf)", color: Colors.YELLOW },
            { value: "vq-step2", name: "Vorqualifizierung Step 2 (Vertriebs-AD/Beratungstermin)", color: Colors.YELLOW },
            { value: "angebot-heizung", name: "Angebot Heizung", color: Colors.BLUE },
            { value: "angebot-photovoltaik", name: "Angebot Photovoltaik", color: Colors.BLUE },
            { value: "besprechungstermin", name: "Besprechungstermin", color: Colors.ORANGE },
            { value: "angebot-mail", name: "Angebot per Mail versenden (Vertriebs-AD)", color: Colors.PURPLE },
            { value: "followup-step1", name: "Follow-Up Step 1 (Mail)", color: Colors.PURPLE },
            { value: "followup-step2", name: "Follow-Up Step 2 (Vertriebs-AD/Anruf)", color: Colors.PURPLE },
            { value: "angebot-angenommen", name: "Angebot angenommen", color: Colors.GREEN },
            { value: "absage", name: "Absage", color: Colors.RED },
            { value: "auftragsvergabe-zurueckgestellt", name: "Auftragsvergabe zurückgestellt", color: Colors.GRAY },
          ],
          attributes: [{ name: PropertyAttributeName.DefaultValue, value: "anfrage-erhalten" }],
        },
        { name: "probability", title: "Probability %", type: "number" },
      ...
      views: [
        {
          ...
          name: "pipeline",
          title: "Pipeline",
          properties: ["title", "amount", "stage", "closeDate", "owner"],
          filters: [],
    ...
    },
    {
      ...
      properties: [
        ...
        { name: "description", title: "Description", type: "string" },
        {
          ...
          attributes: [{ name: PropertyAttributeName.DefaultValue, value: "new" }],
        },
        {
          name: "priority",
          title: "Priority",
          type: "select",
          options: [
            { value: "low", name: "Low", color: Colors.GREEN },
            { value: "medium", name: "Medium", color: Colors.BLUE },
            { value: "high", name: "High", color: Colors.ORANGE },
            { value: "urgent", name: "Urgent", color: Colors.RED },
          ],
        },
        { name: "category", title: "Category", type: "string" },
        { name: "dueAt", title: "Due At", type: "date" },
        { name: "owner", title: "Owner", type: "string" },
      ],
      views: [
        {
          ...
          name: "tickets",
          title: "Tickets",
          properties: ["title", "status", "priority", "owner", "dueAt"],
          filters: [],
  ...
  relationships: [
    { parent: "company", child: "contact", type: "one-to-many", order: 1 },
    { parent: "company", child: "opportunity", type: "one-to-many", order: 2 },
    { parent: "company", child: "ticket", type: "one-to-many", order: 3 },
    { parent: "contact", child: "opportunity", type: "one-to-many", order: 4, label: "Primary contact" },
    { parent: "contact", child: "ticket", type: "one-to-many", order: 5, label: "Requester" },
  ],
};
  ...
  entities: [
    {
      ...
      isAutogenerated: true,
      hasApi: true,
      icon: '<svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="64" height="64" viewBox="0 0 64 64"> <path d="M 11 9 C 8.791 9 7 10.791 7 13 L 7 55 L 57 55 L 57 13 C 57 10.791 55.209 9 53 9 L 11 9 z M 11 19 L 53 19 L 53 51 L 11 51 L 11 19 z M 45.074219 24.072266 L 40 28 L 37.027344 25.521484 L 35.015625 27.748047 L 40 33 L 47.119141 26.271484 L 45.074219 24.072266 z M 17 27 L 17 31 L 31 31 L 31 27 L 17 27 z M 45.074219 37.072266 L 40 41 L 37.027344 38.521484 L 35.015625 40.748047 L 40 46 L 47.119141 39.271484 L 45.074219 37.072266 z M 17 40 L 17 44 L 31 44 L 31 40 L 17 40 z"></path> </svg>',
      active: true,
      hasTags: false,
      hasComments: false,
      hasTasks: false,
