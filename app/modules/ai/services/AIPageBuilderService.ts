...
import ContentBlockPrompt from "../prompts/pageBlocks/ContentBlockPrompt";
...
In case there are images, use the placeholder "https://placehold.co/$Widthx$Height?text=$ImageTitle".
